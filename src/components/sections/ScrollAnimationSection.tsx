...
export function ScrollAnimationSection() {
    ...
    return (
        <section ref={sectionRef} className="relative">
            ...
            <div
                ref={triggerRef}
                className="relative w-full overflow-hidden bg-gradient-to-b from-muted/20 to-muted/40 flex flex-col items-center py-12 md:block md:h-screen md:py-0"
            >
                {/* Background pattern */}
                ...
                <div
                    ref={truckRef}
                    className="relative w-full max-w-[500px] mb-12 z-10 md:absolute md:left-0 md:top-1/2 md:-translate-y-1/2 md:w-[120vw] md:max-w-[1600px] md:min-w-[500px] md:mb-0 will-change-transform"
                >
                    <Image
                        src="/truck-2.png"
                        alt="AM Movers Truck"
                ...
                <div
                    ref={text1Ref}
                    className="relative w-[90vw] max-w-md p-12 bg-[#F25C24] text-white shadow-2xl z-20 flex flex-col justify-center items-center text-center mb-8 md:absolute md:right-8 md:md:right-16 md:lg:right-24 md:top-1/2 md:-translate-y-1/2 md:w-[95vw] md:max-w-2xl md:md:max-w-3xl md:p-20 md:md:p-24 md:lg:p-28 md:mb-0 will-change-transform"
                    style={{
                ...
                <div
                    ref={text2Ref}
                    className="relative w-[90vw] max-w-md p-12 bg-[#F25C24] text-white shadow-2xl z-20 flex flex-col justify-center items-center text-center md:absolute md:left-8 md:md:left-16 md:lg:left-24 md:top-1/2 md:-translate-y-1/2 md:w-[95vw] md:max-w-2xl md:md:max-w-3xl md:p-20 md:md:p-24 md:lg:p-28 will-change-transform"
                    style={{
